// §17's composed subject-scoped entry point (WEEK3_ARCHITECTURE.md, Phase 9):
...
//
// This is WEEK3_ARCHITECTURE.md §28's `/api/learning/next-activity` (GET {subject} -> {concept,
