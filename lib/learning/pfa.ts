// Performance Factors Analysis -- pure, deterministic, no I/O (WEEK3_ARCHITECTURE.md §8).
//
...
export const PFA_PLATEAU_WINDOW = 4; // WEEK3_ARCHITECTURE.md §8 -- fixed at 4 by the audited source, not product-tunable
export const PFA_PLATEAU_DELTA = 0.025; // WEEK3_ARCHITECTURE.md §8 -- ditto
