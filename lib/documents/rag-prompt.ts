...
// WEEK3_ARCHITECTURE.md §21/§22, Phase 10 -- the ONE new optional input this file gains.
...
// WEEK3_ARCHITECTURE.md §11/§12's prompt-layering + priority order, restated exactly as the trust
