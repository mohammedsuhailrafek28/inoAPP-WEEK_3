-- Week 3 Phase 2 -- concept registry + lightweight prerequisite DAG (WEEK3_ARCHITECTURE.md §6).
--
...
create table if not exists public.learning_concepts (
  ...
  -- BKT prior/learning-rate overrides (WEEK3_ARCHITECTURE.md §7.4) -- columns exist now so Phase 3
...
-- ---------------------------------------------------------------------------------------------
-- Event-ledger FK upgrade (Step 14 / WEEK3_ARCHITECTURE.md §25's own note: "Phase 2 adds ... once
