// Week 3 learner-foundation types (WEEK3_ARCHITECTURE.md §4, §25, §27).
...
// WEEK3_ARCHITECTURE.md §31 / Decision 2 (locked): stale detection is a recovery mechanism,
...
// Full catalog per WEEK3_ARCHITECTURE.md §25 — the DB CHECK constraint (migration 004) allows
...
//
// Phase 3 adds QUIZ_ANSWERED -- WEEK3_ARCHITECTURE.md §25 already names this (not a new
...
// --- Concept registry & prerequisite graph (WEEK3_ARCHITECTURE.md §6, Phase 2) --------------------
...
// target itself excluded (WEEK3_ARCHITECTURE.md Step 12's "getPrerequisiteLearningOrder").
export interface PrerequisitePath {
  targetConceptId: string;
  order: ConceptGraphNode[];
}

// --- BKT mastery & PFA practice signal (WEEK3_ARCHITECTURE.md §7, §8, Phase 3) -----------------
...
// --- IRT ability & adaptive difficulty (WEEK3_ARCHITECTURE.md §9, §16, Phase 4) -----------------
...
// --- Retention & review scheduling (WEEK3_ARCHITECTURE.md §10, Phase 5) -------------------------
//
...
// --- Prerequisite readiness (WEEK3_ARCHITECTURE.md §6, Phase 6) ---------------------------------
//
...
// --- Misconceptions (WEEK3_ARCHITECTURE.md §11, Phase 6) ----------------------------------------
//
...
// --- Transfer (WEEK3_ARCHITECTURE.md §12, Phase 6) ----------------------------------------------
//
...
// --- Calibration (WEEK3_ARCHITECTURE.md §13, Phase 6) --------------------------------------------
//
...
// --- Autonomy / Scaffolding (WEEK3_ARCHITECTURE.md §15, Phase 7) --------------------------------
//
...
// §15's exact three tiers (bounds corrected in the Revision 3 lock -- WEEK3_ARCHITECTURE.md §6A's
...
// --- Episodic memory (WEEK3_ARCHITECTURE.md §5 Layer D, Phase 7) --------------------------------
//
...
// --- Narrative memory (WEEK3_ARCHITECTURE.md §5 Layer E / §5.1, Phase 7) ------------------------
//
...
// --- Pedagogical decision engine (WEEK3_ARCHITECTURE.md §17, Phase 8) ---------------------------
//
...
// --- Phase FSM & concept selection (WEEK3_ARCHITECTURE.md §17.1/§17.2, Phase 9) ------------------
//
...
// supplied target concept. Phase 9's quiz-generation contract breaks that: WEEK3_ARCHITECTURE.md
...
// --- Quiz architecture (WEEK3_ARCHITECTURE.md §18/§19/§20, Phase 9) ------------------------------
//
