...
export type ActivePanel = "progress" | "practice" | "profile" | null;
  ...
  return (
    <header className="flex-shrink-0 border-b border-line">
      <div className="mx-auto flex max-w-[1140px] items-center justify-between px-6 py-4">
        ...
        {/* Laptop/desktop: restrained text navigation (Step 5/22). */}
        ...
        <div className="flex items-center gap-1">
          {/* Tablet/mobile: the same three drawers as compact, accessibly-labeled icons (Step 5/25). */}
