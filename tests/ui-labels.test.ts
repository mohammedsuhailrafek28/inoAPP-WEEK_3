...
import { ACTION_LABEL, CALIBRATION_LABEL, DIFFICULTY_LABEL, PEDAGOGICAL_REASON_LABEL, REVISION_REASON_LABEL, SCAFFOLDING_LABEL, STAGE_GLYPH, STAGE_LABEL, TRANSFER_LABEL, revisionIntentLabel } from "@/lib/ui/labels";
